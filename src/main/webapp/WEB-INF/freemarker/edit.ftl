...
<#include "/include/header.ftl"><div class="g-doc">
    ...
    <#else>
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/shop/product/autheditSubmit?id=${product.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt"  name="image_url" value="${product.imageUrl}" placeholder="图片地址"/>
                </div>
        ...
        <span class="imgpre"><img src="${product.imageUrl}" alt="" id="imgpre"></span>
    </div>
    </#if>
</div>
<#include "/include/footer.ftl">
<script type="text/javascript" src="/shop/js/global.js"></script>
<script type="text/javascript" src="/shop/js/public.js"></script>
</body>
</html>